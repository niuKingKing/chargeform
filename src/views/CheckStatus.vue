    ...
    <div class="container">
        <el-form ref="form" :rules="rules" :model="form" label-width="100px">
            <el-form-item label="委托单号" prop="ordernumber">
                <el-input v-model="form.ordernumber" placeholder="请输入委托单号"></el-input>
            </el-form-item>
...
import { checkCode } from '@/api/common';
export default {
    components: {
        verificationCode
    },
        ...
        handleQuery() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    checkCode({entrustOddNumber:this.form.ordernumber,verifyCode: this.form.code }).then(res => {
